...
class Settings : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        privacyLayout.setOnClickListener { openWebsite("https://www.tradeveil.com/privacy-policy") }
        termsLayout.setOnClickListener { openWebsite("https://www.tradeveil.com/terms-of-service") }
